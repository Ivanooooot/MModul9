...
namespace DemoWebShop.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        // Varijabla koja ima pristup ulogama u tablici AspNetRoles
        ...
        public class InputModel
        {
            ...
            // Ovo smo dodali kako bi proširili formu za registraciju
    ...
    public async Task OnGetAsync(string returnUrl = null)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // dodijeljivanje vrijednosti klasi user iz HTML forme registracije
